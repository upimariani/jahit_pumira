    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Pesanan Return</h5>
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($pengembalian['pengembalian'] as $key => $value) {
                                ?>
                                    <tr>
                                        <th scope="row"><?= $no++ ?></th>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <h4><strong>Rp. <?= number_format($value->total_bayar, 0)  ?></strong></h4><span class="badge bg-danger">Return</span>
                                        </td>
